...
\end{equation}
где шаг сетки $h=1$ по всем направлениям, т.к. он соответствует расстоянию между пикселями; $|N_p|$ — число ближайших соседей точки $p$ или, что то же самое, число элементов множества $N_p \cap \Omega$.

	\begin{comment}
\begin{equation}
\Delta f = \frac{\partial^2 f}{\partial x_1} + \frac{\partial^2 f}{\partial x_2} + \ldots + \frac{\partial^2 f}{\partial^2 x_n}
\end{equation}
\begin{align}
\frac{\partial^2 f}{\partial x_i^2} = \frac{1}{h^2} \left( f(x_1,\ldots,x_i+h,\ldots,x_n) - 2f(x_1,\ldots,x_i,\ldots,x_n)+\right.\\
\left. + f(x_1,\ldots,x_i-h,\ldots,x_n) \right), & i=\overline{1,n} \nonumber
\end{align}
\end{comment}
